...
| [Locality](infra/locality.md) | Package-door and single-owner rules landed with frozen baselines. Left: Postgres door burn-down (28 modules), reach-in burn-down (308 keys), a co-change sweeper index, core contract snapshots, a PR-description locality note |
