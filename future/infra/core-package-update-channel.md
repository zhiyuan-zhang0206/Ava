...
- Update coordination: `shared/cluster_lock.py`, `cli/commands/status.py:_update_in_flight`, `shared/source_tree_guard.py` (tamper detection, alert-only); objects-only fetch: `cli/commands/_packages_refresh.py`.
