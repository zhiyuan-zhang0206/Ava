...
- `update_model_pricing.py` + `plugin_price_sync.py` — fail-closed official price checks and conservative archive-to-plugin rate synchronization for reviewed pricing PRs
