...
_ALLOWED_FILES = frozenset(
    {
        ...
        "shared/pty_sessions/launch.py",  # same child-env handoff as host.py: the pty fork + envfile overlay moved here when host.py was split at the 800-line ceiling (issue #2063)
        ...
        "cli/commands/impersonation.py",  # AVA_IMPERSONATION_TOKEN is an explicit per-controller credential handoff; it is neither persisted cluster config nor inherited native agent identity
