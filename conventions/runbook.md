...
- **Hosted runner (the flagship layer)** — the end state the fleet is moving
  ...
  hosted-aware lifecycle) is built behind `AVA_RUNNER_MODE=hosted` (default
  `process`); the historical hibernation layer (controller, `hibernating`
