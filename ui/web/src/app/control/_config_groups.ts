...
export const GROUP_ENV_VARS: Record<string, string[]> = {
  ...
  "config-daemon-tasks": [
    ...
    "AVA_HIERARCHY_WORKER_POLL_SECONDS",
    "AVA_HIERARCHY_JOB_BUDGET_SECONDS",
    "AVA_HIERARCHY_JOB_DEADLINE_SECONDS",
    "AVA_HIERARCHY_RETRY_BACKOFF_SECONDS",
    "AVA_HIERARCHY_RETRY_BACKOFF_CAP_SECONDS",
    "AVA_HIERARCHY_GENERATION_CONCURRENCY",
    "AVA_HIERARCHY_CHILD_KILL_GRACE_SECONDS",
    "AVA_HIERARCHY_STALE_GRACE_SECONDS",
  ],
  "config-gateway": [
