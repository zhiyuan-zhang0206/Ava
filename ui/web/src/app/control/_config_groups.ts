...
export const GROUP_ENV_VARS: Record<string, string[]> = {
  "config-llm": [
    ...
    "AVA_LLM_SILENT_IDLE_MAX_CONSECUTIVE",
    "AVA_LLM_OVERRIDE",
  ],
  "config-prompts": [
  ...
  "config-daemon-heartbeat": [
    ...
    "AVA_HIBERNATE_IDLE_THRESHOLD_SECONDS",
    "AVA_HIBERNATE_MIN_ACTIVE",
  ],
  "config-daemon-tasks": [
    "AVA_RESTARTER_POLL_INTERVAL_SECONDS",
    "AVA_ALLOCATED_REAP_GRACE_SECONDS",
