  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        ...
        "after:absolute after:top-0 after:bottom-0 after:left-1/2 after:w-px after:-translate-x-1/2 after:bg-border after:transition-colors hover:after:bg-primary/40 data-[resize-handle-state=drag]:after:bg-primary/60",
