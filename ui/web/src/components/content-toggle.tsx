...
export function ContentToggle() {
  ...
  return (
    ...
    >
      <span
        className="px-2 py-0.5 text-[11px] font-mono font-medium text-foreground/80 border-r border-border select-none"
      >
        {t("details")}
      </span>
      <select
        ...
        className={cn(
          "appearance-none px-1.5 py-0.5 pr-4 text-[11px] font-mono font-medium",
