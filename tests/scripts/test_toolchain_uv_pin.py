...
embeds the same values because it runs before Python exists on a fresh box, and
the CI workflows pin setup-uv with the same version; these tests fail when any
of the copies drift.
"""
