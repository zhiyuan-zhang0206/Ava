...
Also pins `cli.prepared_plan`'s validation-to-acknowledgement contract, folded
in from `tests/cli/test_prepared_plan_entry.py` at the structure budget (task
#4129 I6).
"""
...
from cli import main, prepared_plan
...
# ── the plan-ack contract of the candidate entry (`cli.prepared_plan`) ───────
