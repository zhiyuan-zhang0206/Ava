...
deliberate contract change, not a silent resurrection).
"""
...
def test_cmd_update_has_no_target_sha_parameter() -> None:
    ...
    assert "rollout_log" not in inspect.signature(cmd_update).parameters
