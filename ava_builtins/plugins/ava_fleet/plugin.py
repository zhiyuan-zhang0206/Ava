...
def _fleet_self_section() -> str:
    return (
        ...
        "genuinely top-level. Every task has an owner: default to yourself, "
        "or use `ava.tasks.create_and_assign` when a known owner should do it; "
        "never create an ownerless backlog.\n\n"
