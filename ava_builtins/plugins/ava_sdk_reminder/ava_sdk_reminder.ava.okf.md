...
description: '`ava_sdk_reminder` gently reminds the agent to use smoother SDK primitives when it uses native Python equivalents. Code-category and agent-reply cadences are independently configurable.'
tags:
- extensions
- plugin
- agent-extension
...
`ava_sdk_reminder` gently reminds the agent to use smoother SDK primitives when it uses native Python equivalents. Code-category and agent-reply cadences are independently configurable.
