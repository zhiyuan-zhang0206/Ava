...
| `agent_updated` | `agents_meta` UPDATE from any writer — resurrect, respawn, claim-node transitions, terminate cleanup, `enter_starting_state`, `mark_agent_exited_op` | `snapshot` |
