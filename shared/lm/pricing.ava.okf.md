...
- **gpt-6-sol** costs $2 input / $0.20 cached / $10 output per 1M for up to 272K input tokens, then $4 / $0.40 / $15 for the full request ([official model page](https://developers.openai.com/api/docs/models/gpt-6-sol), checked 2026-09-25). Cache writes cost $2.50 per 1M and are not modeled. `gpt-5.6-sol` remains spawnable and is display-superseded.
