...
- **Deploy state & liveness (R1)** — the explicit-model tables + lease APIs (deployment_state, host_deploy_state, home lifecycle mutexes, pause capability, updater handoff, agent alive predicate, watcher registry): [[deploy-state.ava.okf.md]].
