...
- **HTTP/RPC API contracts** (`shared/api_contracts/`): gateway↔cli HTTP response types (`ConfigFieldView`/`ConfigSectionView` etc.), route idempotency/pause declarations (`contracts.py`), and the runner RPC envelope (`op_envelope.py`).
