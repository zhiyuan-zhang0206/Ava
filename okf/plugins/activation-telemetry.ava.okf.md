...
Two consumers read the stream. In the aggregate fetch path (`shared/metrics/metrics_aggregate.py` + `shared/metrics/metrics_aggregate_loki.py`'s `_aggregate_tasks`), the
