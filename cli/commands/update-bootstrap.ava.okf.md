...
Before acquiring the existing updater mutex or changing a service, it verifies
...
The existing handoff record journals compensating inputs before quiesce. An
...
followed by dead-owner recovery. This is not mixed-version compatibility proof.
