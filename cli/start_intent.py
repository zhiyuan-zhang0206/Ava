...
def _inputs(args: argparse.Namespace, home: Path) -> IdentityInput:
    ...
    return IdentityInput(home, registry, _checkout(), args.worktree, roles, values, digest)
...
def _prepare_start_locked(args: argparse.Namespace, home: Path) -> None:
    inputs = _inputs(args, home)
