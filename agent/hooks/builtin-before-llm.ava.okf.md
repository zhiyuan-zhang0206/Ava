...
description: The three unconditionally registered built-in before_llm hooks — compact (force-compact near the context limit), repair (dangling tool pairing), capability-index drift (newly installed skills note) — and their registration order.
tags:
- agent
- hooks
---
