...
code-update, or pause-recovery controllers. Reusable hold eligibility and attempt
state remain in `shared.hold_watchdog`; evaluating that state is not executing or
completing a transition. No OS watchdog-probe or hold-watchdog job remains.
