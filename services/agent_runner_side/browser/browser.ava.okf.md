...
- **The healthcheck's ERROR lines are episode-gated**: one line per failure episode + a 6h reminder; quiet rounds log DEBUG ([[services/healthchecks/terminal-verdict.ava.okf.md]]).
