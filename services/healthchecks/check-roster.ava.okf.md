...
| `pitr_uploader.py` | PITR uploader | HTTP `/healthz` (identity-verified): disk footprint + unacked-age health | `respawn_and_verify` | uploader loop alive; critical domain states read degraded (no watchdog flaps) |
