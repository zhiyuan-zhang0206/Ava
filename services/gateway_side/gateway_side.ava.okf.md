...
| delivery-watchdog | Wake dispatcher + stale-pending alerter + terminated-owner resurrect retry + stalled crash-marked harvest request | [[delivery_watchdog.ava.okf.md]] |
...
| pitr-uploader | Disabled-by-default encrypted immutable GCS WAL uploader | [[services/gateway_side/backup/backup.ava.okf.md]] |
